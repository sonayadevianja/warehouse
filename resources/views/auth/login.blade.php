			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
                    ...
                    @enderror
								...
								<button type="submit" class="btn btn-lg btn-block" style="background-color: #C79A56; color: black;">{{ __('Login') }}</button>
								<div class="bottom">
									<span class="helper-text"><a href="{{ route('register') }}" style="color: #C79A56;">Don't have an Account?</a></span>
								</div>
							</form>
						</div>
					</div>
